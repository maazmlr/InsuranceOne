...
function CommCarPlan() {
    ...
    console.log(state)
    useEffect(() => {
        axios.get('http://localhost:3000/commercialPost', {
    ...
    return (
        <div>
            ...
            <Card carName={data.carName} heading={"Commercial Car Details"} carModel={data.carModel} carYear={data.carYear} carPrize={data.carPrize} name={data.fullName} email={data.email} phone={data.phone} prize={data.insurancePrize} />
            {elements}
        </div>
    )
}
