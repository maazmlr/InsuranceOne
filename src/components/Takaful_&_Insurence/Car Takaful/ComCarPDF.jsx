    ...
    return (
        <Document>
            <Page size="A4" style={styles.box} wrap>
                ...
                <Head />
                <CustInfo name={data.fullName} heading={"Commercial Car Details"} email={data.email} phone={data.phone} hospLimit={data.insurancePrize} cName={data.carName} cModel={data.carModel} cYear={data.carYear} cPrice={data.carPrize} />
                <Heading head={"Get Best Commercial Car Takaful & Insurance Deals in Pakistan"} head1={"Protect your Car & loved ones' future with reliable Car insurance plans"} />
                {elements}
                <Foot1 policy={"Commercial Car Takaful & Insurance"} />
            </Page>
        </Document>
    )
}
export default ComCarPDF