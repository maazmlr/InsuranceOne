 ...
 />)
    return(
        ...
        <Page size="A4" style={styles.box} wrap>
          <Head />
          <CustInfo name={data.fullName} heading={"Customer Details"} email={data.email} age={`Parents Age: ${data.parentsAge}`}  phone={data.phone} hospLimit={data.insurancePrize}/>
